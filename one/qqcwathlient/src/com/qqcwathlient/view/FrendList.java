...
public class FrendList extends JFrame implements ActionListener,MouseListener{
	...
	public FrendList(){
		...
		for (int i=1;i<haoyoulb1;i++){
			haoyou1[i]=new JLabel(i+"",new ImageIcon("images/QQ2.jpg"), JLabel.LEFT);
			haoyou1[i].addMouseListener(this);
			mblb1.add(haoyou1[i]);
		}
		had1=new JScrollPane(mblb1);
		ym2.add(had1);
		
		mb2=new JPanel(new GridLayout(2,1));
		hy1=new JButton("我的好友");
		hy1.addActionListener(this);
		msr1=new JButton("陌生人");
